...
def main():
    ...
    for tournament in active_tournaments:
        ...
        #move this to the create_tournament_obj func, as that is what is actually creatig the tournament ----- JK The function only handles the crewation of python objects
        ...
        if  Tournament.objects.filter(detail_id=tourn_obj.detail_id):
            ...
            tourn_obj.save()
        #tourn_detail_elements = get_tournament_detai, tourn_obj)
